...
public enum VentilationFactorEnum {
    ...
    public static void main(String[] args) {
    	for (VentilationFactorEnum ventilationFactorEnum : VentilationFactorEnum.values()) {
			
    		System.out.println(ventilationFactorEnum);
		}
    	System.out.println("------------------------------0");
    	Stream.of(VentilationFactorEnum.values()).forEach(System.out::println);
    	System.out.println("------------------------------1");
    	Stream.of(VentilationFactorEnum.values()).forEach(e -> System.out.println(e.getDescTr()));
	}
